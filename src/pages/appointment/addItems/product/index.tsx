        ...
        <SafeAreaWithStatusBar>
            ...
            <ScrollView>
                <View style={{ padding: getCustomSize(15) }}>
                    ...
                    <Text style={{ fontSize: 18, fontFamily: AppFonts.FontsMedium, color: AppColor.BLACK_COLOR, marginHorizontal: 15, marginVertical: 15 }}>Select Brands</Text>
                    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                        ...
                        <View style={styles.appointmentView}>
                            <View style={styles.appointmentImageView} />
                            <Text style={styles.appointmentStatusText}>Dove</Text>
                        </View>
                        <View style={styles.appointmentView}>
                            <View style={styles.appointmentImageView} />
                            <Text style={styles.appointmentStatusText}>Garnier</Text>
                        </View>
                        <View style={styles.appointmentView}>
                            <View style={styles.appointmentImageView} />
                            <Text style={styles.appointmentStatusText}>M.A.C</Text>
                        </View>
                    </ScrollView>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                        <View style={{ flexDirection: 'row' }}>
                            <View style={{ elevation: 5, backgroundColor: AppColor.WHITE_COLOR, borderRadius: getCustomSize(10) }}>
                                <Image
                                    source={{ uri: DEMO_GIRL_IMAGE }}
                                    style={{ width: 70, height: 60, borderRadius: getCustomSize(10) }}
                                    resizeMode='contain' />
                            </View>
                            <View>
