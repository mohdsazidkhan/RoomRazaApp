...
type Props = NativeStackScreenProps<RootStackParamList, 'DiscountCardScreen'>
export default function DiscountCardScreen({navigation}:Props) {
    return (
        <SafeAreaWithStatusBar>
            <HeaderWithBackButton
                headerTitle='Select Discount Cards'
                            ...
                            <ImageBackground
                                ...
                                <LinearGradient
                                    ...
                                    <View style={styles.cardDetailView}>
                                        <View style={{ flex: 1.5 }}>
                                            <Text style={styles.planName}>Discount Card</Text>
                                            <Pressable>
                        ...
                        <View style={styles.subCardView}>
                            ...
                            <ImageBackground
                                ...
                                <LinearGradient
                                    ...
                                    <View style={styles.cardDetailView}>
                                        <View style={{ flex: 1.5 }}>
                                            <Text style={styles.planName}>Discount Plan</Text>
                                            <Pressable>
                                                <Text style={styles.memberTextButton}>6 Members</Text>
                                            </Pressable>
                                            <Text style={styles.detailText}>Lorem Ipsum is simply dummy text of the printing and typesetting</Text>
                        ...
                        <View style={styles.subCardView}>
                            ...
                            <ImageBackground
                                ...
                                <LinearGradient
                                    ...
                                    <View style={styles.cardDetailView}>
                                        <View style={{ flex: 1.5 }}>
                                            <Text style={styles.planName}>Discount Extension</Text>
                                            <Pressable>
                                                <Text style={styles.memberTextButton}>6 Members</Text>
                                            </Pressable>
                                            <Text style={styles.detailText}>Lorem Ipsum is simply dummy text of the printing and typesetting</Text>
