...
type Props = NativeStackScreenProps<RootStackParamList, 'StepsForStylist'>

export default function StepsForStylistScreen({ navigation }: Props) {
    return (
        <SafeAreaWithStatusBar>
            <HeaderWithBackButton
                headerTitle='Select Steps For Stylist'
            ...
            <ScrollView>
                ...
                <View style={{ padding: 15 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Text style={{ marginVertical: 20, fontSize: AppFontSize.FontsSize_18, color: AppColor.EERIE_BLACK, fontFamily: AppFonts.FontsBold }}>Suggested</Text>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <CustomCheckBox
                                themeColor={AppColor.DEEP_SPACE_SPARKLE} />
                            <Text style={{ marginVertical: 20, fontSize: AppFontSize.FontsSize_18, color: AppColor.DEEP_SPACE_SPARKLE, fontFamily: AppFonts.FontsRegular }}>Select All</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ elevation: 3, backgroundColor: AppColor.WHITE_COLOR, marginBottom: 10, paddingBottom: 15, borderRadius: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <CustomCheckBox
                                themeColor={AppColor.DEEP_SPACE_SPARKLE} />
                            <Text style={{ marginHorizontal: 20, flex: 1, fontFamily: AppFonts.FontsMedium, color: AppColor.EERIE_BLACK, fontSize: AppFontSize.FontsSize_20 }}>Steps 1</Text>
                            <Text style={{ marginHorizontal: 20, fontFamily: AppFonts.FontsRegular, color: AppColor.EERIE_BLACK, fontSize: AppFontSize.FontsSize_15 }}>5 mins</Text>
                        </View>
                    ...
                    <View style={{ elevation: 3, backgroundColor: AppColor.WHITE_COLOR, marginBottom: 10, paddingBottom: 15, borderRadius: 10 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <CustomCheckBox
                                themeColor={AppColor.DEEP_SPACE_SPARKLE} />
                            <Text style={{ marginHorizontal: 20, flex: 1, fontFamily: AppFonts.FontsMedium, color: AppColor.EERIE_BLACK, fontSize: AppFontSize.FontsSize_20 }}>Steps 2</Text>
                            <Text style={{ marginHorizontal: 20, fontFamily: AppFonts.FontsRegular, color: AppColor.EERIE_BLACK, fontSize: AppFontSize.FontsSize_15 }}>5 mins</Text>
                        </View>
                        <Text style={{ marginHorizontal: 50, fontFamily: AppFonts.FontsRegular, color: AppColor.EERIE_BLACK, fontSize: AppFontSize.FontsSize_15 }}>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                        ...
                        <View style={{ flex: 1, marginLeft: 10 }}>
                            <CustomButton
                                ...
                                handlePress={() => navigation.navigate('AddStationRoom')} />
                        </View>
                    </View>
